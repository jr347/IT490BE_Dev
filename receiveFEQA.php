...
$channel_send->queue_declare('beqa_receive', false, true, false, false);
...
$callback = function($req) {
	...
	$channel_send->basic_publish($msg, '', 'beqa_receive');
...
$channel_rec->basic_consume('beqa_send', '', false, false, false, false, $callback);
